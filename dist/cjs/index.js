...
const Heading = ({ order = 1, textAlign, children }) => {
    ...
    let headingElement = (jsxRuntime.jsx("h1", { className: `${styles$1.headingOne} ${textAlignStyles}`, children: children }));
    switch (order) {
        case 2:
            headingElement = jsxRuntime.jsx("h2", { className: `${styles$1.headingTwo} ${textAlignStyles}`, children: children });
            break;
        case 3:
            headingElement = jsxRuntime.jsx("h3", { className: `${styles$1.headingThree} ${textAlignStyles}`, children: children });
            break;
    }
...
const Header = ({ children }) => {
    return (jsxRuntime.jsx("header", { className: styles.header, children: jsxRuntime.jsx(Heading, { order: 2, children: children }) }));
};
...
const FlexContainer = ({ children, align, className, flexDirection, gap, headerText, justify, styledContainer, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: `${styles$2.flexContainer} ${flexDirectionStyles} ${justifyStyles} ${alignStyles} ${gapStyles} ${styledContainerStyles} ${className}`, children: [!!headerText && jsxRuntime.jsx(Header, { children: headerText }), styledContainer && jsxRuntime.jsx("div", { className: styles$2.childrenStyles, children: children }), !styledContainer && children] }));
};
